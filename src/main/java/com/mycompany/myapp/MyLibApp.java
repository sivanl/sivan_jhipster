...
public class MyLibApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(MyLibApp.class);

    private final Environment env;

    public MyLibApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MyLibApp.class);
